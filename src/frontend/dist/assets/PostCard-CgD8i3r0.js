import { c as createLucideIcon, r as reactExports, Y as reactDomExports, j as jsxRuntimeExports, _ as Primitive, $ as useComposedRefs, a0 as createContextScope, a1 as useSize, a2 as useCallbackRef, a3 as useLayoutEffect2, a4 as useDirection, a5 as Presence, a6 as Portal$1, a7 as composeEventHandlers, a8 as createCollection, a9 as hideOthers, aa as Item, ab as dispatchDiscreteCustomEvent, ac as createRovingFocusGroupScope, ad as useFocusGuards, ae as ReactRemoveScroll, af as FocusScope, ag as DismissableLayer, ah as Root$1, ai as createSlot, aj as composeRefs, ak as useControllableState, al as useId, E as cn, u as useAuth, am as useToggleLike, an as useDeletePost, J as useProfile, ao as useFlagPost, l as Link, A as Avatar, g as PostPrivacy, h as Lock, B as Button, ap as Flag, aq as Dialog, ar as DialogContent, as as DialogHeader, at as DialogTitle, au as DialogDescription, av as DialogFooter, k as ue } from "./index-xPxN8AW-.js";
import { T as Textarea } from "./textarea-fj3e2o8j.js";
import { T as Trash2 } from "./trash-2-Ct8i_2I0.js";
import { H as Heart, M as MessageCircle } from "./EmptyState-CJ3DDLhk.js";
import { S as Share2 } from "./share-2-CD7Th5Pc.js";
/**
...
function PostCard({ post, index: index2 = 1, pinned }) {
  ...
  const isOwner = (identity == null ? void 0 : identity.getPrincipal().toString()) === post.authorId.toString();
  ...
  const handleReport = async () => {
    ...
    try {
      ...
      ue.success("Post reported. Moderators will review it.");
      setReportOpen(false);
      setReportReason("");
    } catch {
      ue.error("Could not report post. Please try again.");
    }
  };
  ...
  const handleDelete = () => {
    deletePost(post.id, {
      ...
      onError: () => ue.error("Could not delete post")
    });
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "article",
    {
      ...
      "data-ocid": `post.item.${index2}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between p-4 pb-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              ...
              "data-ocid": `post.author_link.${index2}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Avatar,
                  {
                    ...
                    size: "md",
                    avatarType: (authorProfile == null ? void 0 : authorProfile.avatarType) === "3d" ? "3d" : "photo",
                    avatar3dConfig: authorProfile == null ? void 0 : authorProfile.avatar3dConfig
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-w-0", children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1.5", children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-display font-semibold text-foreground text-sm truncate", children: (authorProfile == null ? void 0 : authorProfile.username) ?? "Loading..." }),
                    pinned && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center gap-0.5 text-xs text-muted-foreground bg-muted px-1.5 py-0.5 rounded-full flex-shrink-0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx(Pin, { className: "w-2.5 h-2.5" }),
                      "Pinned"
                    ] }),
                    post.privacy === PostPrivacy.followersOnly && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex items-center gap-0.5 text-xs text-muted-foreground bg-muted px-1.5 py-0.5 rounded-full flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Lock, { className: "w-2.5 h-2.5" }) })
                  ] }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-xs", children: timeAgo(post.createdAt) })
                ] })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenu, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DropdownMenuTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                "data-ocid": `post.options_button.${index2}`,
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs(DropdownMenuContent, { align: "end", children: [
              isOwner && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                DropdownMenuItem,
                {
                  ...
                  "data-ocid": `post.delete_button.${index2}`,
                  children: [
              ...
              identity && !isOwner && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                DropdownMenuItem,
                {
                  onClick: () => setReportOpen(true),
                  "data-ocid": `post.report_button.${index2}`,
                  children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-4 pb-3", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-foreground text-sm leading-relaxed whitespace-pre-wrap", children: post.content }) }),
        post.imageBlob && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mx-4 mb-3 rounded-xl overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 px-4 py-3 border-t border-border/50", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              onClick: handleLike,
              disabled: liking,
              className: `flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-sm transition-smooth hover:bg-primary/10 ${liked ? "text-primary" : "text-muted-foreground hover:text-primary"}`,
              "data-ocid": `post.like_button.${index2}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Heart,
                  {
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: likeCount.toString() })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              ...
              "data-ocid": `post.comment_button.${index2}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(MessageCircle, { className: "w-4 h-4" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: post.commentCount.toString() })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              ...
              "data-ocid": `post.share_button.${index2}`,
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(Share2, { className: "w-4 h-4" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-medium", children: "Share" })
              ]
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Dialog, { open: reportOpen, onOpenChange: setReportOpen, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogContent, { className: "sm:max-w-md", "data-ocid": "post.report_dialog", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogHeader, { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(DialogTitle, { children: "Report Post" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx(DialogDescription, { children: "Tell us why this post should be reviewed by moderators." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Textarea,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(DialogFooter, { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: flagging ? "Submitting..." : "Submit Report"
              }
            )
          ] })
        ] }) })
