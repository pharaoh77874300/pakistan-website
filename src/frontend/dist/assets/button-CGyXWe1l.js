...
import { k as ProtocolError, T as TimeoutWaitingForResponseErrorCode, l as utf8ToBytes, E as ExternalError, M as MissingRootKeyErrorCode, C as Certificate, m as lookupResultToBuffer, n as RequestStatusResponseStatus, U as UnknownError, o as RequestStatusDoneNoReplyErrorCode, p as RejectError, q as CertifiedRejectErrorCode, s as UNREACHABLE_ERROR, I as InputError, t as InvalidReadStateRequestErrorCode, v as ReadRequestType, d as Principal, w as IDL, x as MissingCanisterIdErrorCode, H as HttpAgent, y as encode, Q as QueryResponseStatus, z as UncertifiedRejectErrorCode, A as isV3ResponseBody, B as isV2ResponseBody, D as UncertifiedRejectUpdateErrorCode, F as UnexpectedErrorCode, G as decode, S as Subscribable, J as pendingThenable, K as resolveEnabled, N as shallowEqualObjects, O as resolveStaleTime, V as noop, W as environmentManager, X as isValidTimeout, Y as timeUntilStale, Z as timeoutManager, _ as focusManager, $ as fetchState, a0 as replaceData, a1 as notifyManager, a2 as hashKey, a3 as getDefaultState, r as reactExports, a4 as shouldThrowError, a as useQueryClient, a5 as useInternetIdentity, a6 as createActorWithConfig, f as React2, g as ReactDOM, j as jsxRuntimeExports, a7 as Record, a8 as Opt, a9 as Variant, aa as Vec, ab as Service, ac as Func, ad as Text, ae as Nat, af as Principal$1, ag as Nat8, ah as Bool, ai as Int, aj as Null, R as React } from "./index-BuiRXQM6.js";
...
Service({
  ...
  "addComment": Func([PostId, Text], [Comment], []),
  "assignCallerUserRole": Func([Principal$1, UserRole], [], []),
  "createPost": Func([CreatePostInput], [PostView], []),
  "createProfile": Func([CreateProfileInput], [ProfileView], []),
  "deleteComment": Func([CommentId], [], []),
  "deletePost": Func([PostId], [], []),
  "followUser": Func([UserId], [], []),
  "getCallerUserProfile": Func([], [Opt(ProfileView)], ["query"]),
  "getCallerUserRole": Func([], [UserRole], ["query"]),
  "getFeed": Func([Nat, Nat], [Page_1], ["query"]),
  "getFollowers": Func([UserId], [Vec(UserId)], ["query"]),
  "getFollowing": Func([UserId], [Vec(UserId)], ["query"]),
  "getFollowingIds": Func([], [Vec(UserId)], ["query"]),
  "getMyProfile": Func([], [Opt(ProfileView)], ["query"]),
  "getPost": Func([PostId], [Opt(PostView)], ["query"]),
  "getProfile": Func([UserId], [Opt(ProfileView)], ["query"]),
  "getProfileByUsername": Func(
    [Text],
    [Opt(ProfileView)],
    ["query"]
  ),
  "getUserProfile": Func([UserId], [Opt(ProfileView)], ["query"]),
  "isCallerAdmin": Func([], [Bool], ["query"]),
  "isFollowing": Func([UserId], [Bool], ["query"]),
  "listAllPosts": Func([Nat, Nat], [Page_1], ["query"]),
  "listComments": Func([PostId], [Vec(Comment)], ["query"]),
  "listPostsByUser": Func([UserId, Nat, Nat], [Page_1], ["query"]),
  "listProfiles": Func([Nat, Nat], [Page], ["query"]),
  "saveCallerUserProfile": Func([CreateProfileInput], [], []),
  "searchPosts": Func([Text], [Vec(PostView)], ["query"]),
  "searchUsers": Func([Text], [Vec(ProfileView)], ["query"]),
  "toggleLike": Func([PostId], [Nat, Bool], []),
  "unfollowUser": Func([UserId], [], []),
  "updateProfile": Func([UpdateProfileInput], [ProfileView], [])
});
const idlFactory = ({ IDL: IDL2 }) => {
  ...
  const CreatePostInput2 = IDL2.Record({
    "content": IDL2.Text,
    "imageBlob": IDL2.Opt(ExternalBlob2)
  });
  ...
  const CreateProfileInput2 = IDL2.Record({
    ...
    "coverBlob": IDL2.Opt(ExternalBlob2)
  });
  ...
  const Page_12 = IDL2.Record({
    "total": IDL2.Nat,
    "nextOffset": IDL2.Opt(IDL2.Nat),
    "items": IDL2.Vec(PostView2)
  });
  const Page2 = IDL2.Record({
    "total": IDL2.Nat,
    "nextOffset": IDL2.Opt(IDL2.Nat),
    "items": IDL2.Vec(ProfileView2)
  });
  ...
  return IDL2.Service({
    ...
    "addComment": IDL2.Func([PostId2, IDL2.Text], [Comment2], []),
    "assignCallerUserRole": IDL2.Func([IDL2.Principal, UserRole2], [], []),
    "createPost": IDL2.Func([CreatePostInput2], [PostView2], []),
    "createProfile": IDL2.Func([CreateProfileInput2], [ProfileView2], []),
    "deleteComment": IDL2.Func([CommentId2], [], []),
    "deletePost": IDL2.Func([PostId2], [], []),
    "followUser": IDL2.Func([UserId2], [], []),
    "getCallerUserProfile": IDL2.Func([], [IDL2.Opt(ProfileView2)], ["query"]),
    "getCallerUserRole": IDL2.Func([], [UserRole2], ["query"]),
    "getFeed": IDL2.Func([IDL2.Nat, IDL2.Nat], [Page_12], ["query"]),
    "getFollowers": IDL2.Func([UserId2], [IDL2.Vec(UserId2)], ["query"]),
    "getFollowing": IDL2.Func([UserId2], [IDL2.Vec(UserId2)], ["query"]),
    "getFollowingIds": IDL2.Func([], [IDL2.Vec(UserId2)], ["query"]),
    "getMyProfile": IDL2.Func([], [IDL2.Opt(ProfileView2)], ["query"]),
    "getPost": IDL2.Func([PostId2], [IDL2.Opt(PostView2)], ["query"]),
    "getProfile": IDL2.Func([UserId2], [IDL2.Opt(ProfileView2)], ["query"]),
    "getProfileByUsername": IDL2.Func(
      [IDL2.Text],
      [IDL2.Opt(ProfileView2)],
      ["query"]
    ),
    "getUserProfile": IDL2.Func([UserId2], [IDL2.Opt(ProfileView2)], ["query"]),
    "isCallerAdmin": IDL2.Func([], [IDL2.Bool], ["query"]),
    "isFollowing": IDL2.Func([UserId2], [IDL2.Bool], ["query"]),
    "listAllPosts": IDL2.Func([IDL2.Nat, IDL2.Nat], [Page_12], ["query"]),
    "listComments": IDL2.Func([PostId2], [IDL2.Vec(Comment2)], ["query"]),
    "listPostsByUser": IDL2.Func(
      [UserId2, IDL2.Nat, IDL2.Nat],
      [Page_12],
      ["query"]
    ),
    "listProfiles": IDL2.Func([IDL2.Nat, IDL2.Nat], [Page2], ["query"]),
    "saveCallerUserProfile": IDL2.Func([CreateProfileInput2], [], []),
    "searchPosts": IDL2.Func([IDL2.Text], [IDL2.Vec(PostView2)], ["query"]),
    "searchUsers": IDL2.Func([IDL2.Text], [IDL2.Vec(ProfileView2)], ["query"]),
    "toggleLike": IDL2.Func([PostId2], [IDL2.Nat, IDL2.Bool], []),
    "unfollowUser": IDL2.Func([UserId2], [], []),
    "updateProfile": IDL2.Func([UpdateProfileInput2], [ProfileView2], [])
  });
};
...
class Backend {
  ...
  async getProfileByUsername(arg0) {
    if (this.processError) {
      try {
  ...
  async listPostsByUser(arg0, arg1, arg2) {
    if (this.processError) {
      try {
...
async function from_candid_Page_1_n24(_uploadFile, _downloadFile, value) {
  return await from_candid_record_n25(_uploadFile, _downloadFile, value);
}
async function from_candid_Page_n28(_uploadFile, _downloadFile, value) {
  return await from_candid_record_n29(_uploadFile, _downloadFile, value);
}
async function from_candid_PostView_n13(_uploadFile, _downloadFile, value) {
  return await from_candid_record_n14(_uploadFile, _downloadFile, value);
}
async function from_candid_ProfileView_n19(_uploadFile, _downloadFile, value) {
...
async function from_candid_record_n20(_uploadFile, _downloadFile, value) {
  return {
    id: value.id,
    bio: value.bio,
...
async function from_candid_vec_n30(_uploadFile, _downloadFile, value) {
...
async function to_candid_CreateProfileInput_n17(_uploadFile, _downloadFile, value) {
...
async function to_candid_UpdateProfileInput_n31(_uploadFile, _downloadFile, value) {
...
function useProfile(userId) {
  const { actor, isFetching } = useActor(createActor);
  const id = userId == null ? void 0 : userId.toString();
  return useQuery({
    queryKey: ["profile", id],
    queryFn: async () => {
...
function useListProfiles(offset = 0n, limit = 20n) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
...
function useFeedPosts(offset = 0n, limit = 20n) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
...
function useAllPosts(offset = 0n, limit = 20n) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
...
function useUserPosts(userId, offset = 0n, limit = 20n) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["userPosts", userId == null ? void 0 : userId.toString(), offset.toString()],
    queryFn: async () => {
      if (!actor || !userId)
...
function usePost(postId) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["post", postId == null ? void 0 : postId.toString()],
    queryFn: async () => {
...
function useSearchPosts(keyword) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
...
function useIsFollowing(userId) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["isFollowing", userId == null ? void 0 : userId.toString()],
    queryFn: async () => {
...
function useFollowers(userId) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["followers", userId == null ? void 0 : userId.toString()],
    queryFn: async () => {
...
function useFollowing(userId) {
  const { actor, isFetching } = useActor(createActor);
  return useQuery({
    queryKey: ["following", userId == null ? void 0 : userId.toString()],
    queryFn: async () => {
      if (!actor || !userId) return [];
...
export {
  ...
  useToggleLike as r,
  useDeletePost as s,
  useUpdateProfile as t,
  useMyProfile as u,
  useCreateProfile as v,
  usePost as w,
  useComments as x,
  useAddComment as y,
  useDeleteComment as z
};
